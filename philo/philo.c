...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/25 15:39:49 by mkoch             #+#    #+#             */
/*   Updated: 2022/04/15 11:29:30 by mkoch            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (input_handling(argc, argv, &data))
		return (1);
	if (init_threads(&data, &philosopher, &supervisor))
		return (1);
	if (join_threads(&data, &philosopher, &supervisor))
		return (1);
	return (0);
}
